    ...
    <footer className="relative border-t border-white/5 mt-10">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="glass-strong border-glow rounded-3xl p-8 md:p-12 mb-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <div className="text-xs uppercase tracking-widest text-[#00FFB3] mb-2">Newsletter</div>
          ...
          <form className="flex w-full md:w-auto gap-2" onSubmit={(e) => e.preventDefault()}>
            <input
              ...
              className="flex-1 md:w-80 px-4 py-3 rounded-full bg-white/[0.03] border border-white/10 text-white placeholder:text-[#A8A8A8]/60 focus:outline-none focus:border-[#00E5FF]/60"
            />
            <button
              type="submit"
              className="px-6 py-3 rounded-full bg-gradient-to-r from-[#00E5FF] to-[#7B61FF] text-black font-semibold"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
            ...
            <div className="mt-6 flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="h-9 w-9 rounded-lg glass border border-white/10 flex items-center justify-center text-[#A8A8A8] hover:text-white hover:border-[#00E5FF]/40 transition-all"
                >
                  <Icon size={15} />
                </a>
              ))}
          ...
          <div>
            <div className="text-xs uppercase tracking-widest text-[#00E5FF] mb-4">Navigate</div>
          ...
          <div>
            <div className="text-xs uppercase tracking-widest text-[#00E5FF] mb-4">Legal</div>
            <ul className="space-y-2">
